...
export const CONFIG_TRASHPOINT_UUID_SET = 'CONFIG_TRASHPOINT_UUID_SET';
export const CONFIG_API_TOKEN_SET = 'CONFIG_API_TOKEN_SET';
export const CONFIG_IS_SIGN_IN_SET = 'CONFIG_IS_SIGN_IN_SET';
export const CONFIG_IMPORT_FINISHED_SET = 'CONFIG_IMPORT_FINISHED_SET';
...
export const PILES_REMOVE_PILE = 'PILES_REMOVE_PILE';
